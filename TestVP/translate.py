...
# Example usage:
input_csv_file = 'VP/eleksyon.csv'  # Replace with the path to your input CSV file
output_csv_file = 'VP/eleksyonTranslated.csv'  # Replace with the desired output CSV file path
