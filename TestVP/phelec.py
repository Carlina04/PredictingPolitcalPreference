...
# Example usage:
input_csv_file = 'VP/phelec.csv'  # Replace with the path to your input CSV file
output_csv_file = 'VP/phelecTranslated.csv'  # Replace with the desired output CSV file path
